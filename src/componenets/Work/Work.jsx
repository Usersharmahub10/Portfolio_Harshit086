  ...
  return (
    <>
      <section id='works'>
        ...
        <span className="workdescriptio">I have earned some certifications in various fields which I want to showcase to you.   <br />
        ...
        <div className="worksimgs">
          ...
          <div>
            <a href="https://drive.google.com/file/d/1FsFTmgDLemmJJMPp3w1XQfRCsdBQ71HC/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">
              <img src={intern} alt="business" className="worksimg" />
            </a>
            <p className="workdescriptio">REACT NATIVE INTERNSHIP</p>
          </div>
          <div>
